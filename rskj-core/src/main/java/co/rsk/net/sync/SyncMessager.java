...
public class SyncMessager {
    ...
    public <T extends MessageWithId> void receiveMessage(NodeID peer, T message) {
    ...
    private <T extends MessageWithId> CompletableFuture<T> sendMessage(NodeID peer, MessageWithId message) {
