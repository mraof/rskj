...
public class NodeMessageHandlerTest {
    ...
    public void processBlockMessageUsingProcessor() throws UnknownHostException {
        ...
        NodeMessageHandler processor = new NodeMessageHandler(config, sbp, null, mock(StateSyncProcessor.class), null, null, scoring, new ProofOfWorkRule(config).setFallbackMiningEnabled(false));
    ...
    public void skipProcessGenesisBlock() throws UnknownHostException {
        ...
        PeerScoringManager scoring = createPeerScoringManager();
        SimpleBlockProcessor sbp = new SimpleBlockProcessor();
        NodeMessageHandler processor = new NodeMessageHandler(config, sbp, null, mock(StateSyncProcessor.class), null, null, scoring, new DummyBlockValidationRule());
    ...
    public void postBlockMessageTwice() throws InterruptedException, UnknownHostException {
        ...
        PeerScoringManager scoring = createPeerScoringManager();
        SimpleBlockProcessor sbp = new SimpleBlockProcessor();
        NodeMessageHandler processor = new NodeMessageHandler(config, sbp, null, mock(StateSyncProcessor.class), null, null, scoring,
    ...
    public void postBlockMessageUsingProcessor() throws InterruptedException, UnknownHostException {
        SimpleBlockProcessor sbp = new SimpleBlockProcessor();
        NodeMessageHandler processor = new NodeMessageHandler(config, sbp, null, mock(StateSyncProcessor.class), null, null, null,
                new ProofOfWorkRule(config).setFallbackMiningEnabled(false));
        Block block = new BlockChainBuilder().ofSize(1, true).getBestBlock();
        Message message = new BlockMessage(block);
    ...
    public void processStatusMessageWithKnownBestBlock() throws UnknownHostException {
        ...
        final SyncProcessor syncProcessor = new SyncProcessor(blockchain, mock(ConsensusValidationMainchainView.class), blockSyncService, RskMockFactory.getPeerScoringManager(), RskMockFactory.getChannelManager(), syncConfiguration, blockFactory, new DummyBlockValidationRule(),
                                                              ...
                                                              null, true);
        final NodeMessageHandler handler = new NodeMessageHandler(config, bp, syncProcessor, mock(StateSyncProcessor.class), null, null, null,
                new ProofOfWorkRule(config).setFallbackMiningEnabled(false));
    ...
    public void processNewBlockHashesMessageDoesNothingBecauseNodeIsSyncing() {
        ...
        final NodeMessageHandler handler = new NodeMessageHandler(config, blockProcessor, null, mock(StateSyncProcessor.class), null, null, null,
                new ProofOfWorkRule(config).setFallbackMiningEnabled(false));
    ...
    public void processTransactionsMessage() throws UnknownHostException {
        ...
        final NodeMessageHandler handler = new NodeMessageHandler(config, blockProcessor, null, mock(StateSyncProcessor.class), null, transactionGateway, scoring,
                new ProofOfWorkRule(config).setFallbackMiningEnabled(false));
    ...
    public void processRejectedTransactionsMessage() throws UnknownHostException {
        ...
        final NodeMessageHandler handler = new NodeMessageHandler(config, blockProcessor, null, mock(StateSyncProcessor.class), channelManager, transactionGateway, scoring,
                new ProofOfWorkRule(config).setFallbackMiningEnabled(false));
    ...
    public void processTransactionsMessageUsingTransactionPool() throws UnknownHostException {
        ...
        final NodeMessageHandler handler = new NodeMessageHandler(config, blockProcessor, null, mock(StateSyncProcessor.class), null, transactionGateway, RskMockFactory.getPeerScoringManager(),
                new ProofOfWorkRule(config).setFallbackMiningEnabled(false));
