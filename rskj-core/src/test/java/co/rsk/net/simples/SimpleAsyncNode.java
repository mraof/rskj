...
public class SimpleAsyncNode extends SimpleNode {
    ...
    public static SimpleAsyncNode createNode(
        ...
        NodeMessageHandler handler = new NodeMessageHandler(config, processor, syncProcessor, null, channelManager, null, peerScoringManager, blockValidationRule, mock(StatusResolver.class));
